...
(function( window ){
    ...
    var defaultSettings = {
        ...
        init: function(){
            ...
            styleSheet.addRule( '.PIER-login-body', 'height: 274px;width: 100%;border-top:1px solid #f5f5f5;');
       ...
       '<div style="font-size:14px;margin-top:10px;margin-left:50px;">品而付</div>');
        ...
        initLoginContainer: function(){
            var $$ = defaultUtils;
            _loginContainer = $$.createElem( 'div', 'PIER-login-container');
            ...
            submitBtn.onclick = function(){
                ...
                $$.http( { url:_url, body:_message}, function( data ){
                    ...
                    _loginContainer.addClass( ['PIER-animated', 'PIER-display-block', 'PIERbounceOutLeft'] );
            ...
            applyBtn.onclick = function(){
                $$.initRegContainer();
                _flipContainer.appendChild(_regContainer);//add reg container for animate only
                setTimeout(function(){
                    _loginContainer.addClass('PIER-login-container-back');
                    _regContainer.addClass('PIER-reg-container-back');
                }, 10);
            }
        },
        /**
        ...
        initRegContainer: function(){
            var $$ = defaultUtils;
            _regContainer = $$.createElem( 'div', 'PIER-reg-container');
            //pay result container header
            ...
            creditBtn.onclick = function(){
                    _loginContainer.removeClass('PIER-login-container-back');
                    _regContainer.removeClass('PIER-reg-container-back');
                    _regContainer.destory();
            }
            submitBtn.onclick = function(){
                ...
                $$.http( { url:_url, body:_message}, function( data ){
                    ...
                    $$.initApplyContainer();
                    _regContainer.addClass( ['PIER-animated', 'PIERbounceOutLeft']  );
                    _regContainer.removeClass( 'PIER-reg-container-back' );

                    _applyContainer.addClass( ['PIER-animated', 'PIER-display-block', 'PIERbounceInRight'] );

                    _flipContainer.appendChild(_applyContainer);
                    _loginContainer.destory();
                    _regContainer.destory();
                }, function( error ){
