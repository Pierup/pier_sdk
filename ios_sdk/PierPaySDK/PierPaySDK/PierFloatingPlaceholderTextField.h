...
#import "RierFloatingPlaceholderConstants.h"

@interface PierFloatingPlaceholderTextField : UITextField

/**
 Enum to switch between upward and downward animation of the floating label.
 */
@property (nonatomic) PierFloatingPlaceholderAnimationOptions animationDirection;
