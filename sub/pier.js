( function() {
  ...
  //CONSTANCE
		...
		ss.addRule( '.checkout', 'width:302px;height:410px;margin:10% auto;z-index:998;background:rgba(248,248,255,1);color:#000;box-shadow:0px 3px 10px #000100;border-radius:5px 5px 5px 5px;border:1px solid #000011;' );
		...
		ss.addRule( '.checkout-logo', 'width:80px;height:80px;margin-left:111px; margin-top:-40px;border-radius:40px;background:#fff;')
